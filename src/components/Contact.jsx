    ...
    <section id="contact" className="contact">
      <div className="section-container">
        ...
        <div className="contact-actions">
          {/* GitHub */}
          <a
            href="https://github.com/Pmayank2005"
            target="_blank"
            rel="noreferrer"
          ...
          {/* Mail */}
          <a
            href="mailto:panditmayank2005@gmail.com"
            className="contact-icon-btn"
            aria-label="Email"
          >
            <span className="contact-icon-ring">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="28" height="28">
                ...
                <polyline points="22,5 12,13.5 2,5" />
              </svg>
            </span>
          </a>
          ...
          {/* LinkedIn */}
          <a
            href="https://linkedin.com/in/mayank-pandit-a7346832a/"
            target="_blank"
            rel="noreferrer"
            className="contact-icon-btn"
            aria-label="LinkedIn"
